...
def send_heartbeat():
    try:
        ...
        r = requests.post("https://us-central1-my-awesome-3e5e8.cloudfunctions.net/api/heartbeat",json={"username":username})
    ...
    while True:
        try:
            ...
            if now - sonheartbeat > datetime.timedelta(minutes=30):
                ...
                r = requests.post("https://us-central1-my-awesome-3e5e8.cloudfunctions.net/api/logs",json={"username":username,"log":log})
...
def main(btn,frm):
    ...
    while True:
        try:
            ...
            r = requests.post("https://us-central1-my-awesome-3e5e8.cloudfunctions.net/api/logs",json={"username":username,"log":str(e)})
            continue
